...
def setup_context(setup_dir):
    ...
    with save_pkg_resources_state(), save_modules(), save_path():
        hide_setuptools()
        with save_argv(), override_temp(temp_dir), pushd(setup_dir):
...
WRITE_FLAGS = functools.reduce(
    ...
    [
        getattr(_os, a, 0)
        for a in ["O_WRONLY", "O_RDWR", "O_APPEND", "O_CREAT", "O_TRUNC", "O_TEMPORARY"]
    ],
)
