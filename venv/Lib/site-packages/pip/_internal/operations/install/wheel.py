...
class ZipBackedFile:
    ...
    def save(self) -> None:
        ...
        with self._zip_file.open(zipinfo) as f, open(self.dest_path, "wb") as dest:
...
def _install_wheel(
    ...
    if pycompile:
        with captured_stdout() as stdout, warnings.catch_warnings():
...
def install_wheel(
    ...
    with ZipFile(wheel_path, allowZip64=True) as z, req_error_context(req_description):
        _install_wheel(
            name=name,
            wheel_zip=z,
