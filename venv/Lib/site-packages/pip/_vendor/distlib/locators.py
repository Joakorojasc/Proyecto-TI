...
class SimpleScrapingLocator(Locator):
    ...
    def _should_queue(self, link, referrer, rel):
        ...
        if (
            ...
            or self.skip_externals
            and not link.startswith(self.base_url)
            or not referrer.startswith(self.base_url)
            or rel not in ("homepage", "download")
            or scheme not in ("http", "https", "ftp")
            or self._is_platform_dependent(link)
        ):
            result = False
        else:
